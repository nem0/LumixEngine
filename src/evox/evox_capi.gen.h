...
namespace Lumix::Evox::generated {
	...
	static void registerGeneratedEngineImport(HashMap<NativeFunctionKey, ex_native_fn, NativeFunctionKeyHash>& functions) {
		...
		functions.insert({StringView("core:property_animator"), StringView("getEnabled")}, &evox_property_animator_isPropertyAnimatorEnabled_12742070177058822018);
		functions.insert({StringView("core:property_animator"), StringView("setEnabled")}, &evox_property_animator_enablePropertyAnimator_11265307580004053127);
		functions.insert({StringView("core:property_animator"), StringView("getLooped")}, &evox_property_animator_getPropertyAnimatorLooped_11673480956432975690);
		functions.insert({StringView("core:property_animator"), StringView("setLooped")}, &evox_property_animator_setPropertyAnimatorLooped_14589021667225761304);
		functions.insert({StringView("core:property_animator"), StringView("getAnimation")}, &evox_property_animator_getPropertyAnimatorAnimation_4677209988032281809);
		functions.insert({StringView("core:property_animator"), StringView("setAnimation")}, &evox_property_animator_setPropertyAnimatorAnimation_17368489730427576649);
		...
		functions.insert({StringView("core:animator"), StringView("getSource")}, &evox_animator_getAnimatorSource_11155504970444435899);
		functions.insert({StringView("core:animator"), StringView("setSource")}, &evox_animator_setAnimatorSource_17892176931136230879);
		functions.insert({StringView("core:animator"), StringView("getUseRootMotion")}, &evox_animator_getAnimatorUseRootMotion_9741305205143477525);
		functions.insert({StringView("core:animator"), StringView("setUseRootMotion")}, &evox_animator_setAnimatorUseRootMotion_9342718108203537783);
		functions.insert({StringView("core:animator"), StringView("getDefaultSet")}, &evox_animator_getAnimatorDefaultSet_17375738426851236115);
		...
		functions.insert({StringView("core:navmesh_zone"), StringView("setDetailed")}, &evox_navmesh_zone_setZoneDetailed_11600996283663539980);
		...
		functions.insert({StringView("core:navmesh_agent"), StringView("getRadius")}, &evox_navmesh_agent_getAgentRadius_563470164329861692);
		functions.insert({StringView("core:navmesh_agent"), StringView("setRadius")}, &evox_navmesh_agent_setAgentRadius_16949384499794200055);
		functions.insert({StringView("core:navmesh_agent"), StringView("getHeight")}, &evox_navmesh_agent_getAgentHeight_1069423188658384351);
		functions.insert({StringView("core:navmesh_agent"), StringView("setHeight")}, &evox_navmesh_agent_setAgentHeight_15021107481936670454);
		functions.insert({StringView("core:navmesh_agent"), StringView("getMoveEntity")}, &evox_navmesh_agent_getAgentMoveEntity_12818649202212790996);
		functions.insert({StringView("core:navmesh_agent"), StringView("setMoveEntity")}, &evox_navmesh_agent_setAgentMoveEntity_13361431652517441269);
		functions.insert({StringView("core:navmesh_agent"), StringView("getSpeed")}, &evox_navmesh_agent_getAgentSpeed_5942787732699741932);
		functions.insert({StringView("core:physical_heightfield"), StringView("getSource")}, &evox_physical_heightfield_getHeightfieldSource_17781085907241680804);
		functions.insert({StringView("core:physical_heightfield"), StringView("setSource")}, &evox_physical_heightfield_setHeightfieldSource_10631205189205149640);
		functions.insert({StringView("core:physical_heightfield"), StringView("getXZScale")}, &evox_physical_heightfield_getHeightfieldXZScale_17927546630134259819);
		functions.insert({StringView("core:physical_heightfield"), StringView("setXZScale")}, &evox_physical_heightfield_setHeightfieldXZScale_15289404238999113653);
		functions.insert({StringView("core:physical_heightfield"), StringView("getYScale")}, &evox_physical_heightfield_getHeightfieldYScale_12976189580294514178);
		functions.insert({StringView("core:physical_heightfield"), StringView("setYScale")}, &evox_physical_heightfield_setHeightfieldYScale_10874814692147059073);
		functions.insert({StringView("core:physical_heightfield"), StringView("getLayer")}, &evox_physical_heightfield_getHeightfieldLayer_5041904754438919339);
		functions.insert({StringView("core:physical_heightfield"), StringView("setLayer")}, &evox_physical_heightfield_setHeightfieldLayer_12968791845034531989);
		functions.insert({StringView("core:d6_joint"), StringView("getXMotion")}, &evox_d6_joint_getD6JointXMotion_14851665169879168421);
		functions.insert({StringView("core:d6_joint"), StringView("setXMotion")}, &evox_d6_joint_setD6JointXMotion_17307665595482720832);
		functions.insert({StringView("core:d6_joint"), StringView("getYMotion")}, &evox_d6_joint_getD6JointYMotion_12817388917696084776);
		functions.insert({StringView("core:d6_joint"), StringView("setYMotion")}, &evox_d6_joint_setD6JointYMotion_106387350368783163);
		functions.insert({StringView("core:d6_joint"), StringView("getZMotion")}, &evox_d6_joint_getD6JointZMotion_15772777298635389478);
		functions.insert({StringView("core:d6_joint"), StringView("setZMotion")}, &evox_d6_joint_setD6JointZMotion_38632995566283774);
		functions.insert({StringView("core:d6_joint"), StringView("getSwing1Motion")}, &evox_d6_joint_getD6JointSwing1Motion_9693653114699259557);
		functions.insert({StringView("core:d6_joint"), StringView("setSwing1Motion")}, &evox_d6_joint_setD6JointSwing1Motion_6901089880810352757);
		functions.insert({StringView("core:d6_joint"), StringView("getSwing2Motion")}, &evox_d6_joint_getD6JointSwing2Motion_6817669413231240915);
		functions.insert({StringView("core:d6_joint"), StringView("setSwing2Motion")}, &evox_d6_joint_setD6JointSwing2Motion_6253924451397780147);
		functions.insert({StringView("core:d6_joint"), StringView("getTwistMotion")}, &evox_d6_joint_getD6JointTwistMotion_15257068924095220544);
		functions.insert({StringView("core:d6_joint"), StringView("setTwistMotion")}, &evox_d6_joint_setD6JointTwistMotion_6928912952611027670);
		functions.insert({StringView("core:d6_joint"), StringView("getLinearLimit")}, &evox_d6_joint_getD6JointLinearLimit_15349128076700613771);
		functions.insert({StringView("core:d6_joint"), StringView("setLinearLimit")}, &evox_d6_joint_setD6JointLinearLimit_15165899222578936725);
		functions.insert({StringView("core:d6_joint"), StringView("getTwistLimit")}, &evox_d6_joint_getD6JointTwistLimit_4496171721025639328);
		functions.insert({StringView("core:d6_joint"), StringView("setTwistLimit")}, &evox_d6_joint_setD6JointTwistLimit_11005610837698845630);
		functions.insert({StringView("core:d6_joint"), StringView("getSwingLimit")}, &evox_d6_joint_getD6JointSwingLimit_11256394858630478399);
		functions.insert({StringView("core:d6_joint"), StringView("setSwingLimit")}, &evox_d6_joint_setD6JointSwingLimit_11111925749191060291);
		functions.insert({StringView("core:d6_joint"), StringView("getDamping")}, &evox_d6_joint_getD6JointDamping_10221431006591640771);
		functions.insert({StringView("core:d6_joint"), StringView("setDamping")}, &evox_d6_joint_setD6JointDamping_10653450751299093694);
		functions.insert({StringView("core:d6_joint"), StringView("getStiffness")}, &evox_d6_joint_getD6JointStiffness_9847380253633775714);
		functions.insert({StringView("core:d6_joint"), StringView("setStiffness")}, &evox_d6_joint_setD6JointStiffness_10658290720952257247);
		functions.insert({StringView("core:d6_joint"), StringView("getRestitution")}, &evox_d6_joint_getD6JointRestitution_5042347982436814904);
		functions.insert({StringView("core:d6_joint"), StringView("setRestitution")}, &evox_d6_joint_setD6JointRestitution_17936001404163028420);
		functions.insert({StringView("core:d6_joint"), StringView("getConnectedBody")}, &evox_d6_joint_getD6JointConnectedBody_4200054913671067562);
		functions.insert({StringView("core:d6_joint"), StringView("setConnectedBody")}, &evox_d6_joint_setD6JointConnectedBody_9997699774107214785);
		functions.insert({StringView("core:d6_joint"), StringView("getAxisPosition")}, &evox_d6_joint_getD6JointAxisPosition_14718916932756373104);
		functions.insert({StringView("core:d6_joint"), StringView("setAxisPosition")}, &evox_d6_joint_setD6JointAxisPosition_14576363621168131187);
		functions.insert({StringView("core:d6_joint"), StringView("getAxisDirection")}, &evox_d6_joint_getD6JointAxisDirection_1377741663140556808);
		functions.insert({StringView("core:d6_joint"), StringView("setAxisDirection")}, &evox_d6_joint_setD6JointAxisDirection_1692054175507140020);
		functions.insert({StringView("core:distance_joint"), StringView("getConnectedBody")}, &evox_distance_joint_getDistanceJointConnectedBody_1434054716758312);
		functions.insert({StringView("core:distance_joint"), StringView("setConnectedBody")}, &evox_distance_joint_setDistanceJointConnectedBody_12657534439748792502);
		functions.insert({StringView("core:distance_joint"), StringView("getAxisPosition")}, &evox_distance_joint_getDistanceJointAxisPosition_11515033595383308468);
		functions.insert({StringView("core:distance_joint"), StringView("setAxisPosition")}, &evox_distance_joint_setDistanceJointAxisPosition_14598389410531043903);
		functions.insert({StringView("core:distance_joint"), StringView("getDamping")}, &evox_distance_joint_getDistanceJointDamping_13782928665327429848);
		functions.insert({StringView("core:distance_joint"), StringView("setDamping")}, &evox_distance_joint_setDistanceJointDamping_3285447076358337367);
		functions.insert({StringView("core:distance_joint"), StringView("getStiffness")}, &evox_distance_joint_getDistanceJointStiffness_16173270783245144469);
		functions.insert({StringView("core:distance_joint"), StringView("setStiffness")}, &evox_distance_joint_setDistanceJointStiffness_17724741753157694102);
		functions.insert({StringView("core:distance_joint"), StringView("getTolerance")}, &evox_distance_joint_getDistanceJointTolerance_16345374829377692530);
		functions.insert({StringView("core:distance_joint"), StringView("setTolerance")}, &evox_distance_joint_setDistanceJointTolerance_14007474814298328015);
		functions.insert({StringView("core:distance_joint"), StringView("getLimits")}, &evox_distance_joint_getDistanceJointLimits_14988408081859678925);
		functions.insert({StringView("core:distance_joint"), StringView("setLimits")}, &evox_distance_joint_setDistanceJointLimits_12543637780255090828);
		functions.insert({StringView("core:distance_joint"), StringView("getLinearForce")}, &evox_distance_joint_getDistanceJointLinearForce_18368188944931014535);
		functions.insert({StringView("core:hinge_joint"), StringView("getConnectedBody")}, &evox_hinge_joint_getHingeJointConnectedBody_15994503914528094622);
		functions.insert({StringView("core:hinge_joint"), StringView("setConnectedBody")}, &evox_hinge_joint_setHingeJointConnectedBody_7875556491297733746);
		functions.insert({StringView("core:hinge_joint"), StringView("getAxisPosition")}, &evox_hinge_joint_getHingeJointAxisPosition_9333331314296799913);
		functions.insert({StringView("core:hinge_joint"), StringView("setAxisPosition")}, &evox_hinge_joint_setHingeJointAxisPosition_18307278449459925821);
		functions.insert({StringView("core:hinge_joint"), StringView("getAxisDirection")}, &evox_hinge_joint_getHingeJointAxisDirection_15280236378732488342);
		functions.insert({StringView("core:hinge_joint"), StringView("setAxisDirection")}, &evox_hinge_joint_setHingeJointAxisDirection_297401759348871008);
		functions.insert({StringView("core:hinge_joint"), StringView("getDamping")}, &evox_hinge_joint_getHingeJointDamping_4645602423959427866);
		functions.insert({StringView("core:hinge_joint"), StringView("setDamping")}, &evox_hinge_joint_setHingeJointDamping_18247942646745760926);
		functions.insert({StringView("core:hinge_joint"), StringView("getStiffness")}, &evox_hinge_joint_getHingeJointStiffness_1452237863060231715);
		functions.insert({StringView("core:hinge_joint"), StringView("setStiffness")}, &evox_hinge_joint_setHingeJointStiffness_5000692854361300243);
		functions.insert({StringView("core:hinge_joint"), StringView("getUseLimit")}, &evox_hinge_joint_getHingeJointUseLimit_4622054269600052655);
		functions.insert({StringView("core:hinge_joint"), StringView("setUseLimit")}, &evox_hinge_joint_setHingeJointUseLimit_10373495169524242986);
		functions.insert({StringView("core:hinge_joint"), StringView("getLimit")}, &evox_hinge_joint_getHingeJointLimit_12614552694852687768);
		functions.insert({StringView("core:hinge_joint"), StringView("setLimit")}, &evox_hinge_joint_setHingeJointLimit_8084324946599403598);
		functions.insert({StringView("core:spherical_joint"), StringView("getConnectedBody")}, &evox_spherical_joint_getSphericalJointConnectedBody_17436513678593960214);
		functions.insert({StringView("core:spherical_joint"), StringView("setConnectedBody")}, &evox_spherical_joint_setSphericalJointConnectedBody_10647608810307015114);
		functions.insert({StringView("core:spherical_joint"), StringView("getAxisPosition")}, &evox_spherical_joint_getSphericalJointAxisPosition_9077846389983423491);
		functions.insert({StringView("core:spherical_joint"), StringView("setAxisPosition")}, &evox_spherical_joint_setSphericalJointAxisPosition_9076329884415739724);
		functions.insert({StringView("core:spherical_joint"), StringView("getAxisDirection")}, &evox_spherical_joint_getSphericalJointAxisDirection_11368225689536224853);
		functions.insert({StringView("core:spherical_joint"), StringView("setAxisDirection")}, &evox_spherical_joint_setSphericalJointAxisDirection_6101817495257316471);
		functions.insert({StringView("core:spherical_joint"), StringView("getUseLimit")}, &evox_spherical_joint_getSphericalJointUseLimit_16520376880044386843);
		functions.insert({StringView("core:spherical_joint"), StringView("setUseLimit")}, &evox_spherical_joint_setSphericalJointUseLimit_14253577254698790444);
		functions.insert({StringView("core:spherical_joint"), StringView("getLimit")}, &evox_spherical_joint_getSphericalJointLimit_2517341946022156772);
		functions.insert({StringView("core:spherical_joint"), StringView("setLimit")}, &evox_spherical_joint_setSphericalJointLimit_8649710650005621340);
		...
		functions.insert({StringView("core:physical_controller"), StringView("getLayer")}, &evox_physical_controller_getControllerLayer_10681862432018985673);
		functions.insert({StringView("core:physical_controller"), StringView("setLayer")}, &evox_physical_controller_setControllerLayer_4500395427114960017);
		functions.insert({StringView("core:physical_controller"), StringView("getRadius")}, &evox_physical_controller_getControllerRadius_13707151154605360232);
		functions.insert({StringView("core:physical_controller"), StringView("setRadius")}, &evox_physical_controller_setControllerRadius_1980177339851090739);
		functions.insert({StringView("core:physical_controller"), StringView("getHeight")}, &evox_physical_controller_getControllerHeight_2218298967685822184);
		functions.insert({StringView("core:physical_controller"), StringView("setHeight")}, &evox_physical_controller_setControllerHeight_9955170084555261553);
		functions.insert({StringView("core:physical_controller"), StringView("getCustomGravity")}, &evox_physical_controller_getControllerCustomGravity_10833915532152078669);
		functions.insert({StringView("core:physical_controller"), StringView("setCustomGravity")}, &evox_physical_controller_setControllerCustomGravity_2080938024535880435);
		functions.insert({StringView("core:physical_controller"), StringView("getCustomGravityAcceleration")}, &evox_physical_controller_getControllerCustomGravityAcceleration_767251138867608339);
		functions.insert({StringView("core:physical_controller"), StringView("setCustomGravityAcceleration")}, &evox_physical_controller_setControllerCustomGravityAcceleration_883562244625708681);
		functions.insert({StringView("core:physical_controller"), StringView("getUseRootMotion")}, &evox_physical_controller_getControllerUseRootMotion_2775193054704344263);
		functions.insert({StringView("core:physical_controller"), StringView("setUseRootMotion")}, &evox_physical_controller_setControllerUseRootMotion_2952442224732328127);
		...
		functions.insert({StringView("core:rigid_actor"), StringView("getVelocity")}, &evox_rigid_actor_getActorVelocity_10593422383750788488);
		functions.insert({StringView("core:rigid_actor"), StringView("getSpeed")}, &evox_rigid_actor_getActorSpeed_16674121296490049712);
		functions.insert({StringView("core:rigid_actor"), StringView("getLayer")}, &evox_rigid_actor_getActorLayer_9509933179744781719);
		functions.insert({StringView("core:rigid_actor"), StringView("setLayer")}, &evox_rigid_actor_setActorLayer_13867100007697589713);
		functions.insert({StringView("core:rigid_actor"), StringView("getDynamicType")}, &evox_rigid_actor_getActorDynamicType_4405303283298304035);
		functions.insert({StringView("core:rigid_actor"), StringView("setDynamicType")}, &evox_rigid_actor_setActorDynamicType_1282153940877898376);
		functions.insert({StringView("core:rigid_actor"), StringView("getIsTrigger")}, &evox_rigid_actor_getActorIsTrigger_4548474388385742385);
		functions.insert({StringView("core:rigid_actor"), StringView("setIsTrigger")}, &evox_rigid_actor_setActorIsTrigger_7337888994561917648);
		functions.insert({StringView("core:rigid_actor"), StringView("getMesh")}, &evox_rigid_actor_getActorMesh_6841595999302178306);
		functions.insert({StringView("core:rigid_actor"), StringView("setMesh")}, &evox_rigid_actor_setActorMesh_3606743997615879415);
		functions.insert({StringView("core:rigid_actor"), StringView("getMaterial")}, &evox_rigid_actor_getActorMaterial_18204827416253874349);
		functions.insert({StringView("core:rigid_actor"), StringView("setMaterial")}, &evox_rigid_actor_setActorMaterial_18440470995069475488);
		functions.insert({StringView("core:rigid_actor"), StringView("getCCD")}, &evox_rigid_actor_getActorCCD_12434411244966946249);
		functions.insert({StringView("core:rigid_actor"), StringView("setCCD")}, &evox_rigid_actor_setActorCCD_12897573747666523655);
		...
		functions.insert({StringView("core:wheel"), StringView("getSpringStrength")}, &evox_wheel_getWheelSpringStrength_9991052682911294062);
		functions.insert({StringView("core:wheel"), StringView("setSpringStrength")}, &evox_wheel_setWheelSpringStrength_18168065559113677475);
		functions.insert({StringView("core:wheel"), StringView("getSpringMaxCompression")}, &evox_wheel_getWheelSpringMaxCompression_12571100289447445433);
		functions.insert({StringView("core:wheel"), StringView("setSpringMaxCompression")}, &evox_wheel_setWheelSpringMaxCompression_6698486979946567210);
		functions.insert({StringView("core:wheel"), StringView("getSpringMaxDroop")}, &evox_wheel_getWheelSpringMaxDroop_3714789021743023958);
		functions.insert({StringView("core:wheel"), StringView("setSpringMaxDroop")}, &evox_wheel_setWheelSpringMaxDroop_6496625313203848390);
		functions.insert({StringView("core:wheel"), StringView("getSpringDamperRate")}, &evox_wheel_getWheelSpringDamperRate_1747981479233960481);
		functions.insert({StringView("core:wheel"), StringView("setSpringDamperRate")}, &evox_wheel_setWheelSpringDamperRate_15195362835632280538);
		functions.insert({StringView("core:wheel"), StringView("getRadius")}, &evox_wheel_getWheelRadius_5797348775871118352);
		functions.insert({StringView("core:wheel"), StringView("setRadius")}, &evox_wheel_setWheelRadius_8678945949368014735);
		functions.insert({StringView("core:wheel"), StringView("getWidth")}, &evox_wheel_getWheelWidth_3962635950944976101);
		functions.insert({StringView("core:wheel"), StringView("setWidth")}, &evox_wheel_setWheelWidth_11797606039286725233);
		functions.insert({StringView("core:wheel"), StringView("getMass")}, &evox_wheel_getWheelMass_8457262383482815212);
		functions.insert({StringView("core:wheel"), StringView("setMass")}, &evox_wheel_setWheelMass_17802761249092374497);
		functions.insert({StringView("core:wheel"), StringView("getMOI")}, &evox_wheel_getWheelMOI_17329225448375028143);
		functions.insert({StringView("core:wheel"), StringView("setMOI")}, &evox_wheel_setWheelMOI_4390672100227953385);
		functions.insert({StringView("core:wheel"), StringView("getSlot")}, &evox_wheel_getWheelSlot_7661196083217858775);
		functions.insert({StringView("core:wheel"), StringView("setSlot")}, &evox_wheel_setWheelSlot_15303303718720374298);
		functions.insert({StringView("core:wheel"), StringView("getRPM")}, &evox_wheel_getWheelRPM_18403735250706726312);
		functions.insert({StringView("core:vehicle"), StringView("getPeakTorque")}, &evox_vehicle_getVehiclePeakTorque_12865377709159215899);
		functions.insert({StringView("core:vehicle"), StringView("setPeakTorque")}, &evox_vehicle_setVehiclePeakTorque_450708605479090462);
		functions.insert({StringView("core:vehicle"), StringView("getMaxRPM")}, &evox_vehicle_getVehicleMaxRPM_7951270875727961620);
		functions.insert({StringView("core:vehicle"), StringView("setMaxRPM")}, &evox_vehicle_setVehicleMaxRPM_15604138286429758706);
		functions.insert({StringView("core:vehicle"), StringView("getRPM")}, &evox_vehicle_getVehicleRPM_2678310156978644759);
		functions.insert({StringView("core:vehicle"), StringView("getCurrentGear")}, &evox_vehicle_getVehicleCurrentGear_1172268433105709381);
		functions.insert({StringView("core:vehicle"), StringView("getSpeed")}, &evox_vehicle_getVehicleSpeed_7397302492130099443);
		functions.insert({StringView("core:vehicle"), StringView("setAccel")}, &evox_vehicle_setVehicleAccel_5738020861438803904);
		functions.insert({StringView("core:vehicle"), StringView("setSteer")}, &evox_vehicle_setVehicleSteer_16986302533023363100);
		functions.insert({StringView("core:vehicle"), StringView("setBrake")}, &evox_vehicle_setVehicleBrake_136883192398412580);
		functions.insert({StringView("core:vehicle"), StringView("getChassis")}, &evox_vehicle_getVehicleChassis_15180539946997534210);
		functions.insert({StringView("core:vehicle"), StringView("setChassis")}, &evox_vehicle_setVehicleChassis_17815561654817463700);
		functions.insert({StringView("core:vehicle"), StringView("getMass")}, &evox_vehicle_getVehicleMass_3826439275636292573);
		functions.insert({StringView("core:vehicle"), StringView("setMass")}, &evox_vehicle_setVehicleMass_15779485969247915754);
		functions.insert({StringView("core:vehicle"), StringView("getMOIMultiplier")}, &evox_vehicle_getVehicleMOIMultiplier_96501381039349968);
		functions.insert({StringView("core:vehicle"), StringView("setMOIMultiplier")}, &evox_vehicle_setVehicleMOIMultiplier_3587670730009285845);
		functions.insert({StringView("core:vehicle"), StringView("getCenterOfMass")}, &evox_vehicle_getVehicleCenterOfMass_13202032159238424522);
		functions.insert({StringView("core:vehicle"), StringView("setCenterOfMass")}, &evox_vehicle_setVehicleCenterOfMass_13714262401650207791);
		functions.insert({StringView("core:vehicle"), StringView("getWheelsLayer")}, &evox_vehicle_getVehicleWheelsLayer_7781415653573910448);
		functions.insert({StringView("core:vehicle"), StringView("setWheelsLayer")}, &evox_vehicle_setVehicleWheelsLayer_15673238082083035607);
		functions.insert({StringView("core:vehicle"), StringView("getChassisLayer")}, &evox_vehicle_getVehicleChassisLayer_471834618907300638);
		functions.insert({StringView("core:vehicle"), StringView("setChassisLayer")}, &evox_vehicle_setVehicleChassisLayer_8473725476134026144);
		functions.insert({StringView("core:physical_instanced_cube"), StringView("getHalfExtents")}, &evox_physical_instanced_cube_getInstancedCubeHalfExtents_5811712922083731358);
		functions.insert({StringView("core:physical_instanced_cube"), StringView("setHalfExtents")}, &evox_physical_instanced_cube_setInstancedCubeHalfExtents_2871694779134560304);
		functions.insert({StringView("core:physical_instanced_cube"), StringView("getLayer")}, &evox_physical_instanced_cube_getInstancedCubeLayer_11007112474105681337);
		functions.insert({StringView("core:physical_instanced_cube"), StringView("setLayer")}, &evox_physical_instanced_cube_setInstancedCubeLayer_10191273074757588333);
		functions.insert({StringView("core:physical_instanced_mesh"), StringView("getLayer")}, &evox_physical_instanced_mesh_getInstancedMeshLayer_14567361767800560888);
		functions.insert({StringView("core:physical_instanced_mesh"), StringView("setLayer")}, &evox_physical_instanced_mesh_setInstancedMeshLayer_5700318157331230762);
		...
		functions.insert({StringView("core:bone_attachment"), StringView("getParent")}, &evox_bone_attachment_getBoneAttachmentParent_18142689017962228472);
		functions.insert({StringView("core:bone_attachment"), StringView("setParent")}, &evox_bone_attachment_setBoneAttachmentParent_3779313276891743601);
		functions.insert({StringView("core:bone_attachment"), StringView("getBone")}, &evox_bone_attachment_getBoneAttachmentBone_2784195155658238731);
		functions.insert({StringView("core:bone_attachment"), StringView("setBone")}, &evox_bone_attachment_setBoneAttachmentBone_4742134950152804761);
		functions.insert({StringView("core:bone_attachment"), StringView("getPosition")}, &evox_bone_attachment_getBoneAttachmentPosition_14063061698960809797);
		functions.insert({StringView("core:bone_attachment"), StringView("setPosition")}, &evox_bone_attachment_setBoneAttachmentPosition_10702452899333319646);
		functions.insert({StringView("core:bone_attachment"), StringView("getRotation")}, &evox_bone_attachment_getBoneAttachmentRotation_4979697275069747087);
		functions.insert({StringView("core:bone_attachment"), StringView("setRotation")}, &evox_bone_attachment_setBoneAttachmentRotation_2627513105013326150);
		...
		functions.insert({StringView("core:particle_emitter"), StringView("getPath")}, &evox_particle_emitter_getParticleEmitterPath_11330173879880210098);
		functions.insert({StringView("core:particle_emitter"), StringView("setPath")}, &evox_particle_emitter_setParticleEmitterPath_13850250279856496269);
		functions.insert({StringView("core:particle_emitter"), StringView("getAutodestroy")}, &evox_particle_emitter_getParticleEmitterAutodestroy_4263130026576218239);
		functions.insert({StringView("core:particle_emitter"), StringView("setAutodestroy")}, &evox_particle_emitter_setParticleEmitterAutodestroy_12841861352903192919);
		functions.insert({StringView("core:instanced_model"), StringView("getPath")}, &evox_instanced_model_getInstancedModelPath_5042885846977672067);
		functions.insert({StringView("core:instanced_model"), StringView("setPath")}, &evox_instanced_model_setInstancedModelPath_11517420952746177454);
		...
		functions.insert({StringView("core:model_instance"), StringView("getEnabled")}, &evox_model_instance_isModelInstanceEnabled_6536336526105476060);
		functions.insert({StringView("core:model_instance"), StringView("setEnabled")}, &evox_model_instance_enableModelInstance_1093951277701741996);
		functions.insert({StringView("core:model_instance"), StringView("getPath")}, &evox_model_instance_getModelInstancePath_480404235994227176);
		functions.insert({StringView("core:model_instance"), StringView("setPath")}, &evox_model_instance_setModelInstancePath_555781892820508759);
		functions.insert({StringView("core:curve_decal"), StringView("getMaterialPath")}, &evox_curve_decal_getCurveDecalMaterialPath_14883722537838298065);
		functions.insert({StringView("core:curve_decal"), StringView("setMaterialPath")}, &evox_curve_decal_setCurveDecalMaterialPath_4325468858749750754);
		functions.insert({StringView("core:curve_decal"), StringView("getHalfExtents")}, &evox_curve_decal_getCurveDecalHalfExtents_6032783605772812549);
		functions.insert({StringView("core:curve_decal"), StringView("setHalfExtents")}, &evox_curve_decal_setCurveDecalHalfExtents_15657074898057640592);
		functions.insert({StringView("core:curve_decal"), StringView("getUVScale")}, &evox_curve_decal_getCurveDecalUVScale_9314353131851647976);
		functions.insert({StringView("core:curve_decal"), StringView("setUVScale")}, &evox_curve_decal_setCurveDecalUVScale_11922830816912627716);
		functions.insert({StringView("core:curve_decal"), StringView("getBezierP0")}, &evox_curve_decal_getCurveDecalBezierP0_3468085010426487511);
		functions.insert({StringView("core:curve_decal"), StringView("setBezierP0")}, &evox_curve_decal_setCurveDecalBezierP0_12067942103955500109);
		functions.insert({StringView("core:curve_decal"), StringView("getBezierP2")}, &evox_curve_decal_getCurveDecalBezierP2_11002163896324231854);
		functions.insert({StringView("core:curve_decal"), StringView("setBezierP2")}, &evox_curve_decal_setCurveDecalBezierP2_14805499181827883260);
		...
		functions.insert({StringView("core:terrain"), StringView("getSize")}, &evox_terrain_getTerrainSize_3020679776041108740);
		functions.insert({StringView("core:terrain"), StringView("getMaterialPath")}, &evox_terrain_getTerrainMaterialPath_2215532021269038697);
		functions.insert({StringView("core:terrain"), StringView("setMaterialPath")}, &evox_terrain_setTerrainMaterialPath_1966540602136072292);
		functions.insert({StringView("core:terrain"), StringView("getXZScale")}, &evox_terrain_getTerrainXZScale_15339317355184973151);
		functions.insert({StringView("core:terrain"), StringView("setXZScale")}, &evox_terrain_setTerrainXZScale_16735516022020384810);
		functions.insert({StringView("core:terrain"), StringView("getTesselation")}, &evox_terrain_getTerrainTesselation_16430938751987681888);
		functions.insert({StringView("core:terrain"), StringView("setTesselation")}, &evox_terrain_setTerrainTesselation_14084944351236148479);
		functions.insert({StringView("core:terrain"), StringView("getBaseGridResolution")}, &evox_terrain_getTerrainBaseGridResolution_6946226270046439418);
		functions.insert({StringView("core:terrain"), StringView("setBaseGridResolution")}, &evox_terrain_setTerrainBaseGridResolution_15993857900103366987);
		functions.insert({StringView("core:terrain"), StringView("getYScale")}, &evox_terrain_getTerrainYScale_6808724379307216299);
		functions.insert({StringView("core:terrain"), StringView("setYScale")}, &evox_terrain_setTerrainYScale_8612193105866137381);
		...
		functions.insert({StringView("core:procedural_geom"), StringView("getMaterial")}, &evox_procedural_geom_getProceduralGeometryMaterial_6522136380315261577);
		functions.insert({StringView("core:procedural_geom"), StringView("setMaterial")}, &evox_procedural_geom_setProceduralGeometryMaterial_11069154491425504953);
		functions.insert({StringView("core:ui_3d"), StringView("getPath")}, &evox_ui_3d_getUI3DPath_14812910613353120667);
		functions.insert({StringView("core:ui_3d"), StringView("setPath")}, &evox_ui_3d_setUI3DPath_9334778907864705763);
		functions.insert({StringView("core:ui_3d"), StringView("getVirtualSize")}, &evox_ui_3d_getUI3DVirtualSize_5246908877923932881);
		functions.insert({StringView("core:ui_3d"), StringView("setVirtualSize")}, &evox_ui_3d_setUI3DVirtualSize_3443593634112763421);
		functions.insert({StringView("core:ui_3d"), StringView("getOrientToCamera")}, &evox_ui_3d_getUI3DOrientToCamera_2472985916441962820);
		functions.insert({StringView("core:ui_3d"), StringView("setOrientToCamera")}, &evox_ui_3d_setUI3DOrientToCamera_10517850954275228651);
