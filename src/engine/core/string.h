...
LUMIX_ENGINE_API void copyMemory(void* dest, const void* src, int count);
LUMIX_ENGINE_API void moveMemory(void* dest, const void* src, int count);
LUMIX_ENGINE_API void setMemory(void* ptr, uint8 value, int num);
