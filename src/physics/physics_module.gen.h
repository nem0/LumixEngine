...
reflection::build_module("physics")
	.function<(EntityPtr (PhysicsModule::*)(Vec3 origin, Vec3 dir, float distance, EntityPtr ignore_entity))&PhysicsModule::raycast>("raycast")
	.function<(void (PhysicsModule::*)(Vec3 gravity))&PhysicsModule::setGravity>("setGravity")
	.function<(u32 (PhysicsModule::*)())&PhysicsModule::getNumControllerHits>("getNumControllerHits")
	.function<(ControllerHitData (PhysicsModule::*)(u32 index))&PhysicsModule::getControllerHit>("getControllerHit")
	.function<(u32 (PhysicsModule::*)())&PhysicsModule::getNumTriggerHits>("getNumTriggerHits")
	.function<(TriggerHitData (PhysicsModule::*)(u32 index))&PhysicsModule::getTriggerHit>("getTriggerHit")
	.function<(u32 (PhysicsModule::*)())&PhysicsModule::getNumContactHits>("getNumContactHits")
	.function<(ContactHitData (PhysicsModule::*)(u32 index))&PhysicsModule::getContactHit>("getContactHit")
	.cmp<&PhysicsModule::createHeightfield, &PhysicsModule::destroyHeightfield>("physical_heightfield", "Physics / Heightfield")
		...
		.prop<&PhysicsModule::getHeightfieldYScale, &PhysicsModule::setHeightfieldYScale>("Y scale")
			.minAttribute(0)
		.prop<&PhysicsModule::getHeightfieldLayer, &PhysicsModule::setHeightfieldLayer>("Layer")
			.attribute<LayerEnum>()
	.cmp<&PhysicsModule::createD6Joint, &PhysicsModule::destroyD6Joint>("d6_joint", "Physics / D6 joint")
		.prop<&PhysicsModule::getD6JointXMotion, &PhysicsModule::setD6JointXMotion>("X motion")
			.attribute<D6MotionEnum>()
		.prop<&PhysicsModule::getD6JointYMotion, &PhysicsModule::setD6JointYMotion>("Y motion")
			.attribute<D6MotionEnum>()
		.prop<&PhysicsModule::getD6JointZMotion, &PhysicsModule::setD6JointZMotion>("Z motion")
			.attribute<D6MotionEnum>()
		.prop<&PhysicsModule::getD6JointSwing1Motion, &PhysicsModule::setD6JointSwing1Motion>("Swing 1")
			.attribute<D6MotionEnum>()
		.prop<&PhysicsModule::getD6JointSwing2Motion, &PhysicsModule::setD6JointSwing2Motion>("Swing 2")
			.attribute<D6MotionEnum>()
		.prop<&PhysicsModule::getD6JointTwistMotion, &PhysicsModule::setD6JointTwistMotion>("Twist")
			.attribute<D6MotionEnum>()
	...
	.cmp<&PhysicsModule::createController, &PhysicsModule::destroyController>("physical_controller", "Physics / Controller")
		.function<(float (PhysicsModule::*)(EntityRef entity) const)&PhysicsModule::getGravitySpeed>("getGravitySpeed")
		.function<(void (PhysicsModule::*)(EntityRef entity, Vec3 v))&PhysicsModule::moveController>("move")
		.function<(bool (PhysicsModule::*)(EntityRef entity) const)&PhysicsModule::isControllerCollisionDown>("isCollisionDown")
		.function<(void (PhysicsModule::*)(EntityRef entity, float height))&PhysicsModule::resizeController>("resize")
		.prop<&PhysicsModule::getControllerLayer, &PhysicsModule::setControllerLayer>("Layer")
			.attribute<LayerEnum>()
	...
	.cmp<&PhysicsModule::createActor, &PhysicsModule::destroyActor>("rigid_actor", "Physics / Actor")
		...
		.function<(void (PhysicsModule::*)(EntityRef entity, Vec3 force, Vec3 pos))&PhysicsModule::addForceAtPos>("addForceAtPos")
		.function<(void (PhysicsModule::*)(EntityRef entity, Vec3 force))&PhysicsModule::applyForceToActor>("applyForce")
		.function<(void (PhysicsModule::*)(EntityRef entity, Vec3 force))&PhysicsModule::applyImpulseToActor>("applyImpulse")
		.prop<&PhysicsModule::getActorVelocity>("Velocity")
		.prop<&PhysicsModule::getActorSpeed>("Speed")
		.prop<&PhysicsModule::getActorLayer, &PhysicsModule::setActorLayer>("Layer")
			.attribute<LayerEnum>()
		.prop<&PhysicsModule::getActorDynamicType, &PhysicsModule::setActorDynamicType>("Dynamic")
	...
	.cmp<&PhysicsModule::createWheel, &PhysicsModule::destroyWheel>("wheel", "Physics / Wheel")
		...
		.prop<&PhysicsModule::getWheelMOI, &PhysicsModule::setWheelMOI>("MOI")
			.minAttribute(0)
		.prop<&PhysicsModule::getWheelSlot, &PhysicsModule::setWheelSlot>("Slot")
	...
	.cmp<&PhysicsModule::createVehicle, &PhysicsModule::destroyVehicle>("vehicle", "Physics / Vehicle")
		...
		.prop<&PhysicsModule::getVehicleWheelsLayer, &PhysicsModule::setVehicleWheelsLayer>("Wheels layer")
			.attribute<LayerEnum>()
		.prop<&PhysicsModule::getVehicleChassisLayer, &PhysicsModule::setVehicleChassisLayer>("Chassis layer")
			.attribute<LayerEnum>()
	.cmp<&PhysicsModule::createInstancedCube, &PhysicsModule::destroyInstancedCube>("physical_instanced_cube", "Physics / Instanced cube")
		...
		.prop<&PhysicsModule::getInstancedCubeLayer, &PhysicsModule::setInstancedCubeLayer>("Layer")
			.attribute<LayerEnum>()
	.cmp<&PhysicsModule::createInstancedMesh, &PhysicsModule::destroyInstancedMesh>("physical_instanced_mesh", "Physics / Instanced mesh")
		.prop<&PhysicsModule::getInstancedMeshLayer, &PhysicsModule::setInstancedMeshLayer>("Layer")
			.attribute<LayerEnum>()
