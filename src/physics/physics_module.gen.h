...
reflection::build_module("physics")
	...
	.function<(Span<const ControllerHitData> (PhysicsModule::*)())&PhysicsModule::getControllerHits>("getControllerHits")
	.function<(Span<const TriggerHitData> (PhysicsModule::*)())&PhysicsModule::getTriggerHits>("getTriggerHits")
	.function<(Span<const ContactHitData> (PhysicsModule::*)())&PhysicsModule::getContactHits>("getContactHits")
	.function<(RaycastHit (PhysicsModule::*)(Vec3 origin, Vec3 dir, float distance, EntityPtr ignored, i32 layer))&PhysicsModule::raycastEx>("raycastEx")
	...
	.cmp<&PhysicsModule::createActor, &PhysicsModule::destroyActor>("rigid_actor", "Physics / Actor")
		...
		.prop<&PhysicsModule::getActorMass, &PhysicsModule::setActorMass>("Mass")
