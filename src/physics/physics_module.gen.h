...
reflection::build_module("physics")
	...
	.function<(bool (PhysicsModule::*)(const Vec3& origin, const Vec3& dir, float distance, RaycastHit& result, EntityPtr ignored, int layer))&PhysicsModule::raycastEx>("raycastEx")
	.function<(bool (PhysicsModule::*)(const DVec3& pos, float radius, const Vec3& dir, float distance, SweepHit& result, EntityPtr ignored, i32 layer))&PhysicsModule::sweepSphere>("sweepSphere")
