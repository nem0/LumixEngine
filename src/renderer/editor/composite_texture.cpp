...
void CompositeTexture::initTerrainAlbedo() {
	...
	inode0->m_texture = "engine/textures/common/red.tga";
	inode1->m_texture = "engine/textures/common/green.tga";
...
void CompositeTexture::initTerrainNormal() {
	...
	onode->m_layers_count = 2;
	onode->m_output_type = OutputNode::OutputType::ARRAY;
	inode0->m_texture = "engine/textures/common/default_normal.tga";
	inode1->m_texture = "engine/textures/common/default_normal.tga";
	link(inode0, 0, onode, 0);
	link(inode1, 0, onode, 1);
}
