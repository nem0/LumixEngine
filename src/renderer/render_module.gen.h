...
reflection::build_module("renderer")
	.function<(RayCastModelHit (RenderModule::*)(const Ray& ray, EntityPtr ignore))&RenderModule::castRay>("castRay", "RenderModule::castRay")
	.function<(RayCastModelHit (RenderModule::*)(const Ray& ray))&RenderModule::castRayTerrain>("castRayTerrain", "RenderModule::castRayTerrain")
	.function<(void (RenderModule::*)(const DVec3& p0, const DVec3& p1, const DVec3& p2, Color color))&RenderModule::addDebugTriangle>("addDebugTriangle", "RenderModule::addDebugTriangle")
	.function<(void (RenderModule::*)(const DVec3& from, const DVec3& to, Color color))&RenderModule::addDebugLine>("addDebugLine", "RenderModule::addDebugLine")
	.function<(void (RenderModule::*)(const DVec3& center, float size, Color color))&RenderModule::addDebugCross>("addDebugCross", "RenderModule::addDebugCross")
	.function<(void (RenderModule::*)(const DVec3& pos, const Vec3& dir, const Vec3& up, const Vec3& right, Color color))&RenderModule::addDebugBone>("addDebugBone", "RenderModule::addDebugBone")
	.function<(void (RenderModule::*)(const DVec3& pos, const Vec3& dir, const Vec3& up, const Vec3& right, Color color))&RenderModule::addDebugCube>("addDebugCube", "RenderModule::addDebugCube")
	.function<(void (RenderModule::*)(const DVec3& from, const DVec3& to, Color color))&RenderModule::addDebugCube>("addDebugCube", "RenderModule::addDebugCube")
	.function<(void (RenderModule::*)(const DVec3& from, const DVec3& max, Color color))&RenderModule::addDebugCubeSolid>("addDebugCubeSolid", "RenderModule::addDebugCubeSolid")
	.function<(void (RenderModule::*)(EntityRef camera))&RenderModule::setActiveCamera>("setActiveCamera", "RenderModule::setActiveCamera")
	.function<(void (RenderModule::*)(EntityRef entity))&RenderModule::setActiveEnvironment>("setActiveEnvironment", "RenderModule::setActiveEnvironment")
	...
	.cmp<&RenderModule::createTerrain, &RenderModule::destroyTerrain>("terrain", "Render / Terrain")
		.function<(float (RenderModule::*)(EntityRef entity, float x, float z))&RenderModule::getTerrainHeightAt>("getHeightAt", "RenderModule::getTerrainHeightAt")
		.function<(Vec3 (RenderModule::*)(EntityRef entity, float x, float z))&RenderModule::getTerrainNormalAt>("getNormalAt", "RenderModule::getTerrainNormalAt")
		...
		.enum_prop<&RenderModule::getGrassRotationMode, &RenderModule::setGrassRotationMode>("Grass rotation mode")
			.attribute<GrassRotationModeEnum>()
		.prop<&RenderModule::getGrassDistance, &RenderModule::setGrassDistance>("Grass distance")
			.minAttribute(1)
		.prop<&RenderModule::getGrassPath, &RenderModule::setGrassPath>("Mesh")
			.resourceAttribute(Model::TYPE)
		.prop<&RenderModule::getGrassSpacing, &RenderModule::setGrassSpacing>("Grass spacing")
		.end_array()
	...
	.cmp<&RenderModule::createModelInstance, &RenderModule::destroyModelInstance>("model_instance", "Render / Mesh")
		.function<(bool (RenderModule::*)(EntityRef entity, u32 mesh_index, const char* uniform_name, Vec4 value))&RenderModule::overrideMaterialVec4>("overrideMaterialVec4", "RenderModule::overrideMaterialVec4")
		.function<(Model* (RenderModule::*)(EntityRef entity))&RenderModule::getModelInstanceModel>("getModel", "RenderModule::getModelInstanceModel")
	...
	.cmp<&RenderModule::createParticleSystem, &RenderModule::destroyParticleSystem>("particle_emitter", "Render / Particle emitter")
		.prop<&RenderModule::getParticleSystemPath, &RenderModule::setParticleSystemPath>("Source")
			.resourceAttribute(ParticleSystemResource::TYPE)
		.prop<&RenderModule::getParticleSystemAutodestroy, &RenderModule::setParticleSystemAutodestroy>("Autodestroy")
	.cmp<&RenderModule::createBoneAttachment, &RenderModule::destroyBoneAttachment>("bone_attachment", "Render / Bone attachment")
		.icon(ICON_FA_BONE)
		.function<(void (RenderModule::*)(EntityRef entity, const Quat& rot))&RenderModule::setBoneAttachmentRotationQuat>("setRotation", "RenderModule::setBoneAttachmentRotationQuat")
		.prop<&RenderModule::getBoneAttachmentParent, &RenderModule::setBoneAttachmentParent>("Parent")
		.enum_prop<&RenderModule::getBoneAttachmentBone, &RenderModule::setBoneAttachmentBone>("Bone")
			.attribute<BoneEnum>()
	...
	.cmp<&RenderModule::createCamera, &RenderModule::destroyCamera>("camera", "Render / Camera")
		.icon(ICON_FA_CAMERA)
		.function<(Ray (RenderModule::*)(EntityRef entity, const Vec2& screen_pos))&RenderModule::getCameraRay>("getRay", "RenderModule::getCameraRay")
