...
reflection::build_module("renderer")
	.function<(Renderer& (RenderModule::*)() const)&RenderModule::getRenderer>("getRenderer")
	...
	.cmp<&RenderModule::createCamera, &RenderModule::destroyCamera>("camera", "Render / Camera")
		...
		.prop<&RenderModule::getCameraScreenWidth>("Screen width")
		.prop<&RenderModule::getCameraScreenHeight>("Screen height")
	...
	.cmp<&RenderModule::createParticleEmitter, &RenderModule::destroyParticleEmitter>("particle_emitter", "Render / Particle emitter")
		.function<(i32 (RenderModule::*)(EntityRef entity, const char* name))&RenderModule::getParticleEmitterGlobalID>("getGlobalID")
		.function<(void (RenderModule::*)(EntityRef entity, i32 id, float value))&RenderModule::setParticleEmitterGlobal>("setFloatGlobal")
		.function<(void (RenderModule::*)(EntityRef entity, i32 id, Vec3 value))&RenderModule::setParticleEmitterGlobal>("setVec3Global")
		.function<(void (RenderModule::*)(EntityRef entity, i32 id, Vec4 value))&RenderModule::setParticleEmitterGlobal>("setVec4Global")
		.function<(void (RenderModule::*)(EntityRef entity, u32 emitter_index, u32 num_ribbons))&RenderModule::emitRibbons>("emitRibbons")
		.function<(void (RenderModule::*)(EntityRef entity, u32 emitter_index, u32 ribbon_index))&RenderModule::killRibbon>("killRibbon")
	...
	.cmp<&RenderModule::createModelInstance, &RenderModule::destroyModelInstance>("model_instance", "Render / Mesh")
		...
		.function<(void (RenderModule::*)(EntityRef entity, u32 mesh_idx, const Path& path))&RenderModule::setModelInstanceMaterialOverride>("setMaterialOverride")
		.function<(Path (RenderModule::*)(EntityRef entity, u32 mesh_idx))&RenderModule::getModelInstanceMaterialOverride>("getMaterialOverride")
