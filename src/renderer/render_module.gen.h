...
reflection::build_module("renderer")
	...
	.function<(void (RenderModule::*)(const DVec3& from, const DVec3& to, Color color))&RenderModule::addDebugLine>("addDebugLine")
	.function<(void (RenderModule::*)(const DVec3& center, float size, Color color))&RenderModule::addDebugCross>("addDebugCross")
	.function<(void (RenderModule::*)(const DVec3& pos, const Vec3& dir, const Vec3& up, const Vec3& right, Color color))&RenderModule::addDebugBone>("addDebugBone")
	.function<(void (RenderModule::*)(const DVec3& pos, const Vec3& dir, const Vec3& up, const Vec3& right, Color color))&RenderModule::addDebugCube>("addDebugCube")
	.function<(void (RenderModule::*)(const DVec3& from, const DVec3& to, Color color))&RenderModule::addDebugCube>("addDebugCube")
	.function<(void (RenderModule::*)(const DVec3& from, const DVec3& max, Color color))&RenderModule::addDebugCubeSolid>("addDebugCubeSolid")
	...
	.cmp<&RenderModule::createBoneAttachment, &RenderModule::destroyBoneAttachment>("bone_attachment", "Render / Bone attachment")
		.icon(ICON_FA_BONE)
		.function<(void (RenderModule::*)(EntityRef entity, const Quat& rot))&RenderModule::setBoneAttachmentRotationQuat>("setRotation")
