...
reflection::build_module("renderer")
	...
	.cmp<&RenderModule::createParticleEmitter, &RenderModule::destroyParticleEmitter>("particle_emitter", "Render / Particle emitter")
		.function<(i32 (RenderModule::*)(EntityRef entity, const char* name))&RenderModule::getParticleEmitterParameterID>("getParameterID")
		.function<(void (RenderModule::*)(EntityRef entity, i32 id, float value))&RenderModule::setParticleEmitterParameter>("setFloatParameter")
		.function<(void (RenderModule::*)(EntityRef entity, i32 id, Vec3 value))&RenderModule::setParticleEmitterParameter>("setVec3Parameter")
		.function<(void (RenderModule::*)(EntityRef entity, i32 id, Vec4 value))&RenderModule::setParticleEmitterParameter>("setVec4Parameter")
