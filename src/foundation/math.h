...
struct LUMIX_FOUNDATION_API IVec2 {
	IVec2() {}
...
struct LUMIX_FOUNDATION_API IVec3 {
	IVec3() {}
...
struct LUMIX_FOUNDATION_API IVec4 {
	IVec4() {}
...
struct LUMIX_FOUNDATION_API DVec2 { 
	DVec2() {}
...
struct LUMIX_FOUNDATION_API Vec2 {
	Vec2() {}
...
struct LUMIX_FOUNDATION_API Vec3 {
	Vec3() {}
...
struct LUMIX_FOUNDATION_API DVec3
{
	DVec3() {}
	DVec3(float a);
...
struct LUMIX_FOUNDATION_API Vec4 {
	Vec4() {}
...
LUMIX_FOUNDATION_API Vec3 operator *(float f, const Vec3& v);
LUMIX_FOUNDATION_API Vec4 operator *(float f, const Vec4& v);
LUMIX_FOUNDATION_API Vec4 operator*(const Vec4& v, float s);

struct LUMIX_FOUNDATION_API Quat
{
	Quat() {}
...
struct LUMIX_FOUNDATION_API DualQuat {
	Quat r;
	Quat d;
};

struct LUMIX_FOUNDATION_API LocalRigidTransform {
...
struct LUMIX_FOUNDATION_API RigidTransform {
	RigidTransform() {}
...
struct LUMIX_FOUNDATION_API LocalTransform {
	LocalTransform() {}
...
struct LUMIX_FOUNDATION_API Transform {
	Transform() {}
...
struct alignas(16) LUMIX_FOUNDATION_API Matrix {
...
struct LUMIX_FOUNDATION_API Matrix4x3 {
	Matrix4x3() {}
...
LUMIX_FOUNDATION_API float dot(const Vec4& op1, const Vec4& op2);
LUMIX_FOUNDATION_API float dot(const Vec3& op1, const Vec3& op2);
LUMIX_FOUNDATION_API float dot(const Vec2& op1, const Vec2& op2);
LUMIX_FOUNDATION_API Vec3 cross(const Vec3& op1, const Vec3& op2);
LUMIX_FOUNDATION_API DVec3 cross(const DVec3& op1, const DVec3& op2);

LUMIX_FOUNDATION_API Vec4 lerp(const Vec4& op1, const Vec4& op2, float t);
LUMIX_FOUNDATION_API float lerp(float a, float b, float t);
LUMIX_FOUNDATION_API Vec3 lerp(const Vec3& op1, const Vec3& op2, float t);
LUMIX_FOUNDATION_API DVec3 lerp(const DVec3& op1, const DVec3& op2, float t);
LUMIX_FOUNDATION_API Vec2 lerp(const Vec2& op1, const Vec2& op2, float t);
LUMIX_FOUNDATION_API Vec3 slerp(const Vec3& a, const Vec3& b, float t);
LUMIX_FOUNDATION_API Quat nlerp(const Quat& q1, const Quat& q2, float t);

LUMIX_FOUNDATION_API u32 nextPow2(u32 v);
LUMIX_FOUNDATION_API u32 log2(u32 v);
LUMIX_FOUNDATION_API float degreesToRadians(float angle);
LUMIX_FOUNDATION_API double degreesToRadians(double angle);
LUMIX_FOUNDATION_API float degreesToRadians(int angle);
LUMIX_FOUNDATION_API float radiansToDegrees(float angle);
LUMIX_FOUNDATION_API Vec2 radiansToDegrees(const Vec2& v);
LUMIX_FOUNDATION_API Vec3 radiansToDegrees(const Vec3& v);
LUMIX_FOUNDATION_API Vec2 degreesToRadians(const Vec2& v);
LUMIX_FOUNDATION_API Vec3 degreesToRadians(const Vec3& v);
LUMIX_FOUNDATION_API float easeInOut(float t);
LUMIX_FOUNDATION_API float angleDiff(float a, float b);
LUMIX_FOUNDATION_API u64 randGUID();
LUMIX_FOUNDATION_API u32 rand();
LUMIX_FOUNDATION_API u32 rand(u32 from, u32 to);
LUMIX_FOUNDATION_API float randFloat();
LUMIX_FOUNDATION_API float randFloat(float from, float to);
LUMIX_FOUNDATION_API DVec2 normalize(const DVec2& value);
LUMIX_FOUNDATION_API Vec2 normalize(const Vec2& value);
LUMIX_FOUNDATION_API Vec3 normalize(const Vec3& value);
LUMIX_FOUNDATION_API Quat normalize(const Quat& value);
LUMIX_FOUNDATION_API float length(const Vec2& value);
LUMIX_FOUNDATION_API float length(const Vec3& value);
LUMIX_FOUNDATION_API double length(const DVec3& value);
LUMIX_FOUNDATION_API float squaredLength(const Vec2& value);
LUMIX_FOUNDATION_API float squaredLength(const Vec3& value);
LUMIX_FOUNDATION_API double squaredLength(const DVec2& value);
LUMIX_FOUNDATION_API double squaredLength(const DVec3& value);
LUMIX_FOUNDATION_API float halton(u32 index, i32 base);

struct LUMIX_FOUNDATION_API RandomGenerator {
