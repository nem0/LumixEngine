...
struct LUMIX_FOUNDATION_API DefaultAllocator final : IAllocator {
	struct Page;
...
struct LUMIX_FOUNDATION_API TagAllocator final : IAllocator {
...
struct LUMIX_FOUNDATION_API BaseProxyAllocator final : IAllocator {
...
struct LUMIX_FOUNDATION_API LinearAllocator : IAllocator {
...
LUMIX_FOUNDATION_API IAllocator& getGlobalAllocator();
