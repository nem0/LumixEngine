...
struct AnimationScene : public IScene
{
	...
	virtual void setAnimatorInput(EntityRef entity, int input_idx, int value) = 0;
	virtual void setAnimatorInput(EntityRef entity, int input_idx, float value) = 0;
	virtual void setAnimatorInput(EntityRef entity, int input_idx, bool value) = 0;
	...
	virtual void setAnimatorDefaultSet(EntityRef entity, int set) = 0;
