...
namespace Lumix
{
	...
	struct AnimationSystemImpl : public AnimationSystem
	{
		public:
			...
			{
				m_engine = &engine;
				engine.getWorldEditor()->registerProperty("animable", LUMIX_NEW(PropertyDescriptor<AnimationSceneImpl>)("preview", &AnimationSceneImpl::getPreview, &AnimationSceneImpl::setPreview, IPropertyDescriptor::FILE));
