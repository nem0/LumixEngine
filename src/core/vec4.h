...
static Vec4 operator *(const Vec4& v, float s)
{
	return Vec4(v.x * s, v.y * s, v.z * s, v.w * s);
}


static float dotProduct(const Vec4& op1, const Vec4& op2)
{
	return op1.x * op2.x + op1.y * op2.y + op1.z * op2.z + op1.w * op2.w;
}

static void lerp(const Vec4& op1, const Vec4& op2, Vec4* out, float t)
{
	float invt = 1.0f - t;
