...
namespace Lumix
{
	...
	class LUMIX_CORE_API ISerializer abstract
	{
		public:
			...
			virtual void deserializeArrayItem(uint32_t& value, uint32_t default_value) = 0;
			virtual void deserializeArrayItem(int32_t& value, int32_t default_value) = 0;
			virtual void deserializeArrayItem(int64_t& value, int64_t default_value) = 0;
			virtual void deserializeArrayItem(float& value, float default_value) = 0;
			virtual void deserializeArrayItem(bool& value, bool default_value) = 0;
			virtual void deserializeArrayItem(char* value, int max_length, const char* default_value) = 0;
			virtual void deserializeArrayItem(string& value, const char* default_value) = 0;
