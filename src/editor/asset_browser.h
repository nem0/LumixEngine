...
struct AssetBrowser {
	...
	virtual bool resourceList(Span<char> buf, struct StableHash32& selected_idx, ResourceType type, float height, bool can_create_new) const = 0;
	...
	virtual void reloadTile(StableHash32 hash) = 0;
