...
{
	Lumix::g_log_info.log("unit") << "Event: " << (u32)event.type;
...
void UT_file_events_device(const char* params)
{
	...
	LUMIX_EXPECT(!(1 << (u32)Lumix::FS::EventType::OPEN_BEGIN & occured_event));
	LUMIX_EXPECT(!(1 << (u32)Lumix::FS::EventType::OPEN_BEGIN & occured_event));
	...
	LUMIX_EXPECT(!(1 << (u32)Lumix::FS::EventType::SIZE_BEGIN & occured_event));
	LUMIX_EXPECT(!(1 << (u32)Lumix::FS::EventType::SIZE_FINISHED & occured_event));
	...
	LUMIX_EXPECT(!(1 << (u32)Lumix::FS::EventType::SEEK_BEGIN & occured_event));
	LUMIX_EXPECT(!(1 << (u32)Lumix::FS::EventType::SEEK_FINISHED & occured_event));
	...
	LUMIX_EXPECT(!(1 << (u32)Lumix::FS::EventType::POS_BEGIN & occured_event));
	LUMIX_EXPECT(!(1 << (u32)Lumix::FS::EventType::POS_FINISHED & occured_event));
	...
	LUMIX_EXPECT(!(1 << (u32)Lumix::FS::EventType::READ_BEGIN & occured_event));
	LUMIX_EXPECT(!(1 << (u32)Lumix::FS::EventType::READ_FINISHED & occured_event));
	...
	LUMIX_EXPECT(!(1 << (u32)Lumix::FS::EventType::CLOSE_BEGIN & occured_event));
	LUMIX_EXPECT(!(1 << (u32)Lumix::FS::EventType::CLOSE_FINISHED & occured_event));
	...
	LUMIX_EXPECT(!(1 << (u32)Lumix::FS::EventType::WRITE_BEGIN & occured_event));
	LUMIX_EXPECT(!(1 << (u32)Lumix::FS::EventType::WRITE_FINISHED & occured_event));
