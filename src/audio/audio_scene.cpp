...
void AudioScene::reflect(Engine& engine) {
	LUMIX_REFL_SCENE(AudioSceneImpl, "audio")
		.LUMIX_REFL_FUNC(AudioScene::setMasterVolume)
		.LUMIX_REFL_FUNC(AudioScene::play)
		.LUMIX_REFL_FUNC(AudioScene::setVolume)
		.LUMIX_REFL_FUNC(AudioScene::setEcho)
		.LUMIX_REFL_CMP(AmbientSound, "ambient_sound", "Audio / Ambient sound")
			.LUMIX_REFL_FUNC_EX(AudioScene::pauseAmbientSound, "pause")
			.LUMIX_REFL_FUNC_EX(AudioScene::resumeAmbientSound, "resume")
			.prop<&AudioScene::isAmbientSound3D, &AudioScene::setAmbientSound3D>("3D")
			.LUMIX_REFL_PROP(AmbientSoundClip, "Sound").resourceAttribute(Clip::TYPE)
		.LUMIX_REFL_CMP(Listener, "audio_listener", "Audio / Listener").icon(ICON_FA_HEADPHONES)
		.LUMIX_REFL_CMP(EchoZone, "echo_zone", "Audio / Echo zone")
		...
		.LUMIX_REFL_CMP(ChorusZone, "chorus_zone", "Audio / Chorus zone")
