...
typedef enum ls_op {
	...
	#define LS_COMPARE_JUMP_OPS(TYPE) \
		LS_OP_EQ_JUMP_FALSE_##TYPE, \
		LS_OP_NE_JUMP_FALSE_##TYPE, \
		LS_OP_LT_JUMP_FALSE_##TYPE, \
		LS_OP_LE_JUMP_FALSE_##TYPE,
	...
	LS_OP_EQ_JUMP_FALSE_BOOL,
	LS_OP_NE_JUMP_FALSE_BOOL,
	LS_OP_EQ_JUMP_FALSE_STRING,
	LS_OP_NE_JUMP_FALSE_STRING,
	LS_OP_EQ_JUMP_FALSE_ENUM,
	LS_OP_NE_JUMP_FALSE_ENUM,
