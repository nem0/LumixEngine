...
namespace physx
{
	...
	*/
	...
	<b>Unit:</b> Radians
	*/
	PX_CUDA_CALLABLE PX_FORCE_INLINE PxF32 PxTan(PxF32 a)						{ return (PxF32)::tan(a);							}
	...
	*/
	...
	<b>Unit:</b> Radians
	*/
	PX_CUDA_CALLABLE PX_FORCE_INLINE PxF32 PxAsin(PxF32 f)						{ return (PxF32)::asin(PxClamp(f,-1.0f,1.0f));	}
	...
	*/
	...
	<b>Unit:</b> Radians
	*/
	PX_CUDA_CALLABLE PX_FORCE_INLINE PxF32 PxAcos(PxF32 f)						{ return (PxF32)::acos(PxClamp(f,-1.0f,1.0f));			}
	...
	*/
	...
	<b>Unit:</b> Radians
	*/
	PX_CUDA_CALLABLE PX_FORCE_INLINE PxF32 PxAtan(PxF32 a)						{ return (PxF32)::atan(a);	}
	...
	*/
	...
	<b>Unit:</b> Radians
	*/
	PX_CUDA_CALLABLE PX_FORCE_INLINE PxF32 PxAtan2(PxF32 x, PxF32 y)			{ return (PxF32)::atan2(x,y);	}
	...
	*/
	...
	PX_CUDA_CALLABLE PX_FORCE_INLINE PxF32 PxLog(PxF32 x)						{ return (PxF32)::log(x); }
