...
struct StructResolvedType : ResolvedType {
	StructResolvedType(ex_arena& arena)
...
struct FunctionResolvedType : ResolvedType {
	FunctionResolvedType(ex_arena& arena) : ResolvedType(ResolvedTypeKind::FUNCTION), params(arena) {}
...
struct UnionResolvedType : ResolvedType {
	UnionResolvedType(ex_arena& arena) : ResolvedType(ResolvedTypeKind::UNION), members(arena) {}
...
struct TemplateFunctionInstance {
	TemplateFunctionInstance(ex_arena& arena) : args(arena) {}
