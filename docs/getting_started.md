...
You can get black.h Engine from [itch.io](https://mikulasflorek.itch.io/black.h-engine) or download standalone zip file from [actions](https://github.com/abdulrhmandeveloper2/black Engine/actions/workflows/deploy.yml).
...
Linux is supported only up to [64b66124cb5e6d5bc8e7f11f129c0d5c63f2268a](https://github.com/abdulrhmandeveloper2/black Engine/commit/64b66124cb5e6d5bc8e7f11f129c0d5c63f2268a) revision. Linux in newer versions is work in progress.

See [this shell script](https://raw.githubusercontent.com/wiki/abdulrhmandeveloper2/black Engine/files/black.h_bootstrap.sh). It will fetch the repository, create makefile, build it and run the editor.
